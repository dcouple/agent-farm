...
3. On resume, read the receipt ONLY. If every verification command passed, accept. Do not open files, do not
   review. If a verification command failed, write a fix brief from the receipt and launch the fixer.
