...
model:
  ...
  reasoning: max
skills: []
description: "Reviewer benchmark: GLM 5.3 Flash with a TARGETED instruction. Identical model and harness to rv-glm-claude; the only variable is what it is told to look for."
---
