...
model:
  ...
  reasoning: high
skills: []
description: "Effort ablation: gpt-5.6-luna at reasoning high, no skills, no subagents. Mirror of the raw writer controls with only the effort level changed."
---
