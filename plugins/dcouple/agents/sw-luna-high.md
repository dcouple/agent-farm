...
model:
  ...
  reasoning: high
skills: []
description: "Hypothesis: Can you save time by dropping a cheap writer one effort notch below its working setting? Effort ablation: gpt-5.6-luna at reasoning high, no skills, no subagents. Mirror of the raw writer controls with only the effort level changed. (vs Astra: 0.10x cost at $0.43, 1.7x slower, 0 of 2 with the identical deterministic failure both times where Luna max passed 10 of 10; refuted)"
---
