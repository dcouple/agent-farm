...
skills:
  ...
  - investigate
  - codebase-explorer
description: "Experiment: Luna Max single writer with test-first implementation and bounded Astra review-fix loop. (vs Astra on the small task ($2.08, 422s): 0.11x at $0.23, 3.1x slower; n=1; independent verification ended with 5 failing tests, not yet checked against the task's baseline-failure list)"
subagents:
  planner:
