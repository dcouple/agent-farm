...
model:
  ...
  reasoning: max
skills: []
description: "Mass security sweep, GLM variant: GLM 5.3 Flash auditing existing code module by module with the sweep-sec-flash body. GLM never ran a scan. Hypothesis: it finds the same two authorisation holes DeepSeek found for under $0.15 a pass. (vs sweep-sec-flash $0.22 to $0.27 per pass: result pending)"
---
