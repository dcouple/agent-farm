...
model:
  ...
  reasoning: max
skills: []
description: "Hypothesis: Can a cheap model writing alone, with nothing added, match the frontier control on well-specified work? Control: Luna Max with no skills and no subagents. Raw cheap-writer baseline. (RESULT 2026-09-20 ladder: max 3 of 3 at mean 1,926 s against xhigh's 1,148 s at equal cost; use exp1-luna-xhigh)"
---
