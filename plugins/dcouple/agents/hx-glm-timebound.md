...
model:
  ...
  reasoning: max
skills: []
description: "Implementer under test: GLM 5.3 Flash on the claude harness, bare, with the bounded scope-first discipline. GLM already passes 5 of 5 at $0.55; this tests whether the discipline changes cost or wall time. (vs Astra $4.42 / 608s: result pending)"
---
