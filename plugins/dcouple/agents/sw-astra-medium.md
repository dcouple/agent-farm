...
model:
  ...
  reasoning: medium
skills: []
description: "Effort ablation: gpt-6-astra at reasoning medium, no skills, no subagents. Mirror of the raw writer controls with only the effort level changed."
---
