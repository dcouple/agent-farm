...
model:
  ...
  reasoning: medium
skills: []
description: "Effort ablation: gpt-6-astra at reasoning medium, no skills, no subagents. Mirror of the raw writer controls with only the effort level changed. (vs Astra high: 1.3x cost at $3.99, 1.1x time at 549s, 2 of 2, tie; as the FIXER baseline $1.73, 3.8 min, 4 of 5 evidenced fixes and it rejected all 3 planted false findings, the only fixer that did)"
---
