...
model:
  ...
  reasoning: low
skills: []
description: "Hypothesis: If the frontier model is given the cheap reviewer's exact time-bounded body, does it also reach 4 of 4, proving the instruction is the effect and the model is only cost? Reviewer under test: Astra at low with rv-deepseek-claude's exact time-bounded, scope-first body. Astra with a generic body scored 1 of 5 at $1.18; DeepSeek and GLM with this body score 4 of 4. Hypothesis: the instruction, not the model, is the whole effect, and Astra becomes the fastest 4-of-4 reviewer. (RESULT 2026-09-20: 3 of 3 runs found 4 of 4 real injections in 1.5 to 1.7 min for $0.81 to $1.02; generic Astra found 1 of 5. The instruction is the whole effect; DeepSeek at low matches it for 2 cents)"
---
