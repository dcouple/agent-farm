...
skills:
  ...
  - investigate
  - codebase-explorer
description: "Hypothesis: Can a cheap model run a team of copies of itself? Experiment: Luna Max orchestrating Luna Max workers with Astra final review. Tests H3 — can a cheap model orchestrate? (vs Astra: $0.38, $0.41 and $9.28 across three trials (an Astra final review ran in the third), mean 0.76x, median 0.09x; 3.2x slower, 2 of 3, slightly worse. The $0.40 quoted before 2026-09-20 was the parent alone)"
subagents:
  worker:
