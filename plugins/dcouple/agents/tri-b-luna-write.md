...
skills:
  ...
  - plan-reviewer
  - codebase-explorer
description: "Tri-model B: Luna writes, DeepSeek reviews, GLM plans and owns the schema contract. Role assignment from our own measured per-dimension scores."
subagents:
  worker:
