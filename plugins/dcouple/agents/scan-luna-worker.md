...
model:
  ...
  reasoning: max
skills: []
description: "Hypothesis: Does a thorough cheap model work as a scan lane under an orchestrator? Scan worker. Luna Max audits ONE assigned module for real defects and reports back. Launched by scan-orchestra; not meant to be run directly. (no Astra scanner baseline; ~$0.30 per module, 4 to 8 min, 6 findings across 4 lanes all self-marked confirmed; the parent orchestrator was the bottleneck, not this lane)"
---
