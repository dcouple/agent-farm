...
skills:
  ...
  - research-web
  - investigate
description: "Hypothesis: Does splitting writing across two cheap models beat either alone? Experimental cross-harness: Luna XHigh orchestrates on Codex, DeepSeek Flash implements on Claude Code."
subagents:
  socrates:
