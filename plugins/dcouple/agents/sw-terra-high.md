...
model:
  ...
  reasoning: high
skills: []
description: "Hypothesis: Where is this cheap model's effort sweet spot, given each model has a different one? Effort ablation: gpt-5.6-terra at reasoning high, no skills, no subagents. Mirror of the raw writer controls with only the effort level changed. (vs Astra on the same task: 0.47x cost at $2.07, ~1x speed at 624s, 2 of 2)"
---
