...
model:
  ...
  reasoning: high
skills: []
description: "Effort ladder: glm at reasoning high with the time-bounded review body; max is rv-glm-timebound / rv-deepseek-claude. Hypothesis: Luna had an effort cliff and Astra did not; if this model is flat at low, review costs under two cents. (result pending)"
---
