...
## 6. Re-QA what the change touched
- List the journeys that pass through the surface and drive them again in the running app: interactions (mouse and keyboard), the data that gets saved, and any downstream effects (notifications, what other users see). Report pass or fail per journey with evidence.
