...
The daemon supplies `ORCHESTRA_BROWSER_EVIDENCE_DIR` for the current attempt; on a local run the dispatch supplies the evidence directory, run id, and attempt id instead.
