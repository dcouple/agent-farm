...
2. Must fix: file and line, what breaks, and which work package owns it. Use the bar below
3. Plan fidelity: packages whose done-when checks do not actually hold
4. Decisions made in flight: assumptions the implementers logged, each judged
