...
Render it with the `page` house standard. Save it under `explainers/` in the work's bundle and add it to the brief's "Related" list. With no brief yet, it gets a bundle of its own.
...
- Work packages, file lists of changes to make, or "next we will implement"
