...
5. Choose a route:
   ...
   - `options-first`: unclear locus, or fixing it forces a design choice. It goes to the planner.
   - `cannot-reproduce`: say what was tried and what evidence would help. Stay in intake.
6. File the report wherever the person tracks work (a GitHub issue, Linear, or another tracker). With no tracker, save it as `index.html` in a bundle of its own in the format at [references/bug-report.md](references/bug-report.md), then stop.
