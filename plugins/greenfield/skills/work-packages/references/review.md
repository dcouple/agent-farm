...
4. Open or update the draft PR with `open-pr`. Run `final-review` for the final review, make every fix yourself, and revalidate the affected criteria. Review follow-ups cover the findings and the fix diff.
