...
- spike notes and any older planning files under `docs/agent/`, unless the repository's conventions keep them. Make sure the pull request links the cover sheet
...
- Deletions only. This step happens after review, so behaviour stays exactly as reviewed. If removing something needs a code change beyond deleting lines this run added, leave it and list it.
